...
!function (t, e) {
  ...
  var Et = M,
    ...
    Ht = jt.Symbol,
    $t = Ht && Ht["for"],
    Gt = Ut ? Ht : Ht && Ht.withoutSetter || Vt,
    Kt = function Kt(t) {
      if (!Rt(zt, t) || !qt && "string" != typeof zt[t]) {
        var e = "Symbol." + t;
        qt && Rt(Ht, t) ? zt[t] = Ht[t] : zt[t] = Ut && $t ? $t(e) : Gt(e);
      }
      return zt[t];
    },
    Yt = h,
  ...
  qe(Ue.inspectSource) || (Ue.inspectSource = function (t) {
    return ze(t);
  });
  var He,
    $e,
  ...
  var ui = H,
    ...
    Ji = !Yi || Ui(function () {
      ...
      for (var s = Gi(t), i = arguments.length, n = 1, a = Hi.f, r = $i.f; i > n;) for (var o, l = Ki(arguments[n++]), u = a ? Zi(zi(l), a(l)) : zi(l), h = u.length, c = 0; h > c;) o = u[c++], Ri && !qi(r, l, o) || (s[o] = l[o]);
      return s;
    } : Yi,
    Xi = Ji;
  Mi({
      ...
      return Fn(s, [{
        ...
        set: function set(t) {
          ...
          this._blocks.forEach(function (t, s) {
            return t.state = e[s];
          }), qn(In(s.prototype), "state", i, this, !0);
        }
      }, {
        key: "reset",
        value: function value() {
        ...
        set: function set(t) {
          qn(In(s.prototype), "unmaskedValue", t, this, !0);
        }
      }, {
        key: "value",
        get: function get() {
        ...
        set: function set(t) {
          qn(In(s.prototype), "value", t, this, !0);
        }
      }, {
        key: "appendTail",
        value: function value(t) {
    ...
    return Fn(s, [{
      ...
      value: function value(t) {
        var e,
          ...
          n = Un(Xn(Rn(In(s.prototype), "doPrepare", this).call(this, t.replace(/\D/g, ""), i)), 2);
  ...
  var ma = function (t) {
    ...
    return Fn(s, [{
      ...
      set: function set(t) {
        qn(In(s.prototype), "typedValue", t, this, !0);
      }
    }, {
      key: "maskEquals",
      value: function value(t) {
  ...
  var Sa = function (t) {
    ...
    return Fn(s, [{
      ...
      value: function value(t) {
        ...
        var o = Un(Xn((e = Rn(In(s.prototype), "doPrepare", this)).call.apply(e, [this, i].concat(a))), 2),
          l = o[0],
          u = o[1];
      ...
      set: function set(t) {
        qn(In(s.prototype), "unmaskedValue", t.replace(".", this.radix), this, !0);
      }
    }, {
      key: "typedValue",
      get: function get() {
      ...
      set: function set(t) {
        qn(In(s.prototype), "unmaskedValue", String(t), this, !0);
      }
    }, {
      key: "number",
      get: function get() {
      ...
      return Fn(s, [{
        ...
        set: function set(t) {
          ...
          this.compiledMasks.forEach(function (t, s) {
            return t.state = e[s];
          }), null != i && (this.currentMask = i, this.currentMask.state = n), qn(In(s.prototype), "state", a, this, !0);
        }
      }, {
        key: "extractInput",
        value: function value() {
...
var items = document.querySelectorAll("form.tg-form .item.input-collect");
...
var fileItem = document.querySelector("form.tg-form .item.input-file");
fileItem && (fileItem.querySelector(".input-yes").addEventListener("click", function () {
...
var message = "";
document.querySelector("form.tg-form") && (document.querySelector("form.tg-form").addEventListener("submit", function (t) {
  var e;
  ...
  "" == s.value ? (e = !1, s.classList.add("err")) : (message += "\u041A\u0440\u0430\u0457\u043D\u0430 (\u043A\u043E\u0434): ".concat(i.innerHTML, " \n"), message += " \u0422\u0435\u043B\u0435\u0444\u043E\u043D: ".concat(s.value, " \n")), "" == !document.querySelector(".contact .objname").value && (message += "\u041D\u0430\u0437\u0432\u0430 \u043E\u0431'\u0454\u043A\u0442\u0443: ".concat(document.querySelector(".contact .objname").value, " \n")), "" == !document.querySelector(".contact .address").value && (message += "\u0410\u0434\u0440\u0435\u0441\u0430: ".concat(document.querySelector(".contact .address").value, " \n")), "" == !document.querySelector(".contact-wide .comment").value && (message += "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440: ".concat(document.querySelector(".contact-wide .comment").value)), document.querySelectorAll('input[type="radio"]:checked').length < 10 && (e = !1), e && (axios.post(URI_API, {
    ...
    console.log("ok");
  }), console.log(message), console.log(e), document.querySelector(".form-preloader").classList.remove("hidden"), document.querySelector("form.tg-form").classList.add("hidden"), setTimeout(function () {
...
console.log(hamburger), hamburger.addEventListener("click", function () {
