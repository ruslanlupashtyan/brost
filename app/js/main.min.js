...
document.querySelector("form.form").addEventListener("submit", function (t) {
  ...
  12 != s.value.split("").length ? e = !1 : (message += "\u041A\u0440\u0430\u0457\u043D\u0430 \u0442\u0430 \u0442\u0435\u043B\u0435\u0444\u043E\u043D: ".concat(i.innerHTML, "  ").concat(s.value, " \n"), console.log(s.value.split("").length)), "" == !document.querySelector(".contact .objname").value && (message += "\u041D\u0430\u0437\u0432\u0430 \u043E\u0431'\u0454\u043A\u0442\u0443: ".concat(document.querySelector(".contact .objname").value, " \n")), "" == !document.querySelector(".contact .address").value && (message += "\u0410\u0434\u0440\u0435\u0441\u0430: ".concat(document.querySelector(".contact .address").value, " \n")), "" == !document.querySelector(".contact-wide .comment").value && (message += "\u041A\u043E\u043C\u0435\u043D\u0442\u0430\u0440: ".concat(document.querySelector(".contact-wide .comment").value)), console.log("AllOk: ".concat(e)), console.log(s.value.split("").length), console.log(i.innerHTML), e && (axios.post(URI_API, {
    ...
    console.log("ok");
  }), document.querySelector(".form-preloader").classList.remove("hidden"), document.querySelector("form.form").classList.add("hidden"), setTimeout(function () {
